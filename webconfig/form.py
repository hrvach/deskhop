...
CONFIG_ = [
    ...
    FormField(77, "Mouse transition force (Best set to 3) ", 3, {"min": 0, "max": 1024}, "uint16", "range"),
...
OUTPUT_ = [
    ...
    FormField(1003, "Screensaver", elem="label", style="Title"),
    FormField(9, "Type", 0, {0: "Disabled", 1: "Pong", 2: "Jitter"}, "uint8"),
